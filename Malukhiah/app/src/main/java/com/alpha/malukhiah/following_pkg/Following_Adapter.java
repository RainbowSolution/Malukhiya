...
public class Following_Adapter extends RecyclerView.Adapter<Following_Adapter.MyViewHolder> {
    ...
    public Following_Adapter(Context activity, List<Datum> List) {
        searchList = List;
        context = activity;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.following_list_row, parent, false);
