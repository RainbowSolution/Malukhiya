...
public class SubChildCategoryAdapter extends BaseAdapter {
    Context context;
    List<SubChildDatum> sectorInfos;
    LayoutInflater inflter;
    String comesFrom;

    public SubChildCategoryAdapter(Context applicationContext, List<SubChildDatum> sectorList, String come) {
