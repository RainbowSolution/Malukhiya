...
public class Main_Chat_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void getWeekendList(){
        ...
        Main_Chat_Adapter adapter = new Main_Chat_Adapter(this, catList);
